...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" => custom highlights for custom KeyWords
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"au BufRead,BufNewFile * syn keyword NoteKeywords NOTE
au BufRead,BufNewFile * syn match NoteKeywords "\<NOTE\>"
highlight NoteKeywords cterm=bold term=bold ctermfg=White ctermbg=Blue
"au BufRead,BufNewFile * highlight NoteKeywords cterm=bold term=bold ctermfg=White ctermbg=Blue
" syn match myNOTE "\<NOTE\>"
